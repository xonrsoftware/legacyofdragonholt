...
function setValues(newEntry){
    ...
    if("os"+i in response[newEntry]){
        if (response[newEntry]["os"+i] == "") { document.getElementById("story").innerHTML += '<br><div class="movetext">'+response[newEntry]["od"+i]+'</div>'; }
        else { document.getElementById("story").innerHTML += '<br><div class="movetext bkrnd-red">'+response[newEntry]["od"+i]+'</div>'; }
    }else { document.getElementById("story").innerHTML += '<br><div class="movetext">'+response[newEntry]["od"+i]+'</div>'; }
}
